...
// Map.addLayer(ee.FeatureCollection(shale_wells.get(0)), {'color':lg}, Well_List_names.get(0).getInfo(), 0, 1); 
// Map.addLayer(ee.FeatureCollection(shale_wells.get(1)), {'color':red}, Well_List_names.get(1).getInfo(), 0, 1); 
// Map.addLayer(ee.FeatureCollection(shale_wells.get(2)), {'color':yellow}, Well_List_names.get(2).getInfo(), 0, 1); 
// Map.addLayer(ee.FeatureCollection(shale_wells.get(3)), {'color':dg}, Well_List_names.get(3).getInfo(), 0, 1); 
// Map.addLayer(ee.FeatureCollection(shale_wells.get(4)), {'color':lb}, Well_List_names.get(4).getInfo(), 0, 1); 
// Map.addLayer(ee.FeatureCollection(shale_wells.get(5)), {'color':db}, Well_List_names.get(5).getInfo(), 0, 1); 
// Map.addLayer(ee.FeatureCollection(shale_wells.get(6)), {'color':pink}, Well_List_names.get(6).getInfo(), 0, 1); 
// Map.addLayer(ee.FeatureCollection(shale_wells.get(7)), {'color':black}, Well_List_names.get(7).getInfo(), 0, 1); 
// Map.addLayer(ee.FeatureCollection(shale_wells.get(8)), {'color':whi}, Well_List_names.get(8).getInfo(), 0, 1); 
// Map.addLayer(ee.FeatureCollection(shale_wells.get(9)), {'color':orange}, Well_List_names.get(9).getInfo(), 0, 1); 
// Map.addLayer(ee.FeatureCollection(shale_wells.get(10)), {'color':lorange}, Well_List_names.get(10).getInfo(), 0, 1); 
// Map.addLayer(ee.FeatureCollection(shale_wells.get(11)), {'color':lyellow}, Well_List_names.get(11).getInfo(), 0, 1); 
...
// Map.addLayer(ee.FeatureCollection(Well_List.get(i)), {'color':red}, os_list_names.get(i).getInfo(), 1, 1); 
Map.addLayer(ee.FeatureCollection(non_shale_well_FB.get(i)), {'color':red}, os_list_names.get(i).getInfo(), 1, 1); 
...
Map.addLayer(ee.FeatureCollection(shale_well_FB.get(i)), {'color':lg}, s_list_names.get(i).getInfo(), 1, 1); 
